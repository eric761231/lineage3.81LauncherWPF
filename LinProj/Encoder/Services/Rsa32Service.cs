...
{
    /// <summary>
    /// 伺服器綑綁用的 RSA-32 金鑰生成服務類別，移植自 L1J3.8Launcher(RUST)參考 src/rsa32.rs。
        ...
        public static Rsa32 Generate()
        {
            ...
            while (true)
            {
                ...
                for (int attempt = 0; attempt < 1024; attempt++)
                {
                    ...
                    if (eOpt is not ulong e || e <= 1 || e >= phi)
                    {
                        continue;
                    }
